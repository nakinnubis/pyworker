...
def call_generate_stream(endpoint_group_name: str, api_key: str, server_url: str) -> None:
    ...
    if endpoint_api_key:
        try:
            ...
            call_generate_stream(
                api_key=endpoint_api_key,  # Use consistent API key
                endpoint_group_name=args.endpoint_group_name,
                server_url=args.server_url,
            )
        ...
        log.error(
            f"Failed to get API key for endpoint {args.endpoint_group_name} "
        )
